...
context_filepath = "/gpfs/fs1/data/gordanlab/yuzehou/Mean_methylation_7mer/K562/TDG_context.txt"
...
#!!! Should change to hardac, upload input
Input_filepath = "/gpfs/fs1/data/gordanlab/yuzehou/Mean_methylation_7mer/Liver/Aligned_liver_preupload.bed"
Output_basepath = "/gpfs/fs1/data/gordanlab/yuzehou/Mean_methylation_7mer/Liver/Result/"
...
for coverage_cutoff in [0, 30, 50]:
